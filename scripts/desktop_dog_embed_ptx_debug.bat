...
"E:\1Cook\Cook\resources\RenderDog\ptx" "E:\1Cook\Cook\framework\engine_core\generated\embedded_ptx.h" "Debug"
echo Exit code: %ERRORLEVEL%
echo Checking if script completed...
if exist "E:\1Cook\Cook\framework\engine_core\generated\embedded_ptx.h" (
